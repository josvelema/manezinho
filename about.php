...
<main>
  ...
  <section class="story-section">
    ...
    <article class="story">
      ...
      <div class="story-wrap">
        <div class="story-img">
          <img src="assets/img/manezinhoDancingSquare.jpg" alt="Photo of Manuel Medeiros" class="manezinhoDance">
        </div>
  ...
  <div class="about-divider pieteRiniEwi">

  </div>
  <section class="story-section present">
    ...
    <article class="story">
      ...
      <div class="story-wrap">
        <div class="story-img">
          <img src="assets/svg/manezinhologo.svg" alt="Logo of Manezinho">
        </div>
        <div class="story-text">
          <p>
          ...
          <p>
            After almost a year of renovation the place opened
